...
const TopPagination = () => {
  return (
    <div className="grid grid-cols-1 gap-y-4 lg:gap-y-0 lg:grid-cols-2 place-content-between py-8">
      <h1 className="font-medium text-lg text-secondary">34 Listings Found</h1>
