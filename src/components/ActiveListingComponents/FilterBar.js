      ...
      <div className="bg-activebg grid grid-cols-1 lg:grid-cols-3 gap-y-6 lg:gap-y-0 py-6 px-8 mt-8 rounded-lg">
        <div className="btn-group flex flex-row space-x-4 items-center">
          <div className="">
            <button
              id="listview"
              className="btn group text-secondary inline-flex items-center"
              onClick={listView}
            >
              <svg
                width="30"
              ...
              >
                <path
                  ...
                  fill="rgba(0, 1, 3, 0.7)"
                  className={`${
                    location.pathname === "/active-listings" ? "fill-viewb" : ""
                  }`}
                />
                <path
                  d="M1 1H21M1 6H21M1 11H21M1 16H21"
                  stroke="rgba(0, 1, 3, 0.7)"
                  className={`${
                    location.pathname === "/active-listings"
                      ? "stroke-viewb"
                      : ""
                  }`}
                  strokeWidth="2"
        ...
        <div className="grid justify-items-center wrapper">
          <button className="btn-secondary inline-flex px-6">
            <svg
              width="21"
              height="23"
              viewBox="0 0 21 23"
            ...
            <span className="pl-2" href="#demo-modal">
        ...
        <div className="flex flex-row items-center lg:justify-end">
          <div className="flex flex-row items-center">
            ...
            <select
              id="countries"
              className="text-secondary bg-white rounded-lg p-4 border-none"
            >
