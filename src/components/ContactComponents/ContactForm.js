...
const ContactForm = () => {
  ...
  return (
    <div className="relative px-8 py-16 lg:p-20 z-10">
      <div className="bg-white w-full lg:w-3/6 border border-[#CDD4E7] mx-auto space-y-6 px-6 py-8 lg:p-12 rounded-2xl">
